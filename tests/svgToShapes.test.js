...
test('SVG strokes preserve non-uniform transforms and reflected shapes have consistent solid/hole winding', () => {
  ...
  const closedStroke = parseSvgToShapes(svg('<path transform="translate(40 0) scale(-1 1)" fill="none" stroke="black" stroke-width="0.3" d="M1 1H39V39H1Z"/>'))
  near(area(closedStroke), 45.6, 0.002)
  near(computeBoundsFromShapes(closedStroke).width, 38.3)
